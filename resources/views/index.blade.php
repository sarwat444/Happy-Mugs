                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            ...
                            <div class="single-product-item text-center">
                                <div class="products-images">
                                    <a href="{{url('shop/product_details')}}" class="product-thumbnail">
                                        <img src="https://i.etsystatic.com/24461419/r/il/f1211a/3009223900/il_1588xN.3009223900_fccv.jpg" class="img-fluid" alt="Product Images">
                                ...
                                <div class="product-content">
                                    <h6 class="prodect-title"><a href="{{url('shop/product_details')}}">Freundin Tasse</a></h6>
                                    <div class="prodect-price">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            ...
                            <div class="single-product-item text-center">
                                <div class="products-images">
                                    <a href="{{url('shop/product_details')}}" class="product-thumbnail">
                                        <img src="https://i.etsystatic.com/24461419/r/il/4112dc/3267601219/il_1588xN.3267601219_c7bc.jpg" class="img-fluid" alt="Product Images">
                                ...
                                <div class="product-content">
                                    <h6 class="prodect-title"><a href="{{url('shop/product_details')}}">Buchstaben Tasse</a></h6>
                                    <div class="prodect-price">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            ...
                            <div class="single-product-item text-center">
                                <div class="products-images">
                                    <a href="{{url('shop/product_details')}}" class="product-thumbnail">
                                        <img src="https://i.etsystatic.com/24461419/r/il/bf3d8c/3213995004/il_1588xN.3213995004_ov18.jpg" class="img-fluid" alt="Product Images">
                                ...
                                <div class="product-content">
                                    <h6 class="prodect-title"><a href="{{url('shop/product_details')}}">Mann Tasse</a></h6>
                                    <div class="prodect-price">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            ...
                            <div class="single-product-item text-center">
                                <div class="products-images">
                                    <a href="{{url('shop/product_details')}}" class="product-thumbnail">
                                        <img src="https://i.etsystatic.com/24461419/r/il/de8f8d/3020502213/il_1588xN.3020502213_hesu.jpg" class="img-fluid" alt="Product Images">
                                ...
                                <div class="product-content">
                                    <h6 class="prodect-title"><a href="{{url('shop/product_details')}}">Verlobung Tasse</a></h6>
                                    <div class="prodect-price">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            ...
                            <div class="single-product-item text-center">
                                <div class="products-images">
                                    <a href="{{url('shop/product_details')}}" class="product-thumbnail">
                                        <img src="https://i.etsystatic.com/24461419/c/2307/1834/384/138/il/d6741b/3210194253/il_340x270.3210194253_juo7.jpg" class="img-fluid" alt="Product Images">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            ...
                            <div class="single-product-item text-center">
                                <div class="products-images">
                                    <a href="{{url('shop/product_details')}}" class="product-thumbnail">
                                        <img src="https://i.etsystatic.com/24461419/c/2348/1866/371/110/il/1a1937/3229061937/il_340x270.3229061937_3q59.jpg" class="img-fluid" alt="Product Images">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            ...
                            <div class="single-product-item text-center">
                                <div class="products-images">
                                    <a href="{{url('shop/product_details')}}" class="product-thumbnail">
                                        <img src="https://i.etsystatic.com/24461419/c/2369/1883/374/101/il/676e75/3229055703/il_340x270.3229055703_b7rs.jpg" class="img-fluid" alt="Product Images">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            ...
                            <div class="single-product-item text-center">
                                <div class="products-images">
                                    <a href="{{url('shop/product_details')}}" class="product-thumbnail">
                                        <img src="https://i.etsystatic.com/24461419/c/2413/1918/330/61/il/cff376/3181346958/il_340x270.3181346958_hx43.jpg" class="img-fluid" alt="Product Images">
